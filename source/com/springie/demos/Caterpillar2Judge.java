 ...
 * </ol>
 *
 * <p>Usage: java com.springie.demos.Caterpillar2Judge [ticks]
 */
public final class Caterpillar2Judge {
  private Caterpillar2Judge() {
  }
  ...
  private static Result scoreWithLockHeld(int ticks) {
    ...
    for (int t = 0; t < measured; t++) {
      ...
      if (!tipped_over) {
        ...
        for (int i = 0; i < Caterpillar2Demo.PYRAMIDS; i++) {
