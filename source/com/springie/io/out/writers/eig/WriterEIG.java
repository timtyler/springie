...
public class WriterEIG {
  ...
  public void write(String filename) {
    ...
    try {
      try {
        ...
        eig
            .add(new XMLWriterAttribute("jointsets", "" + this.number_jointsets));
        eig.add(new XMLWriterAttribute("springsets", ""
  ...
  private XMLWriterTagPair outputLink(Link link) {
    ...
    final int n1 = this.nodes.indexOf(link.nodes[0]);
    final int n2 = this.nodes.indexOf(link.nodes[1]);

    final XMLWriterCharacters chars = new XMLWriterCharacters(" " + n1 + " "
        + n2 + " ");
