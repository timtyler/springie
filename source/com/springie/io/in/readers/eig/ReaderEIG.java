  ...
  public void startElement(String uri, String name, String qName,
    ...
    if ("".equals(uri)) {
      ...
      if (link_group) {
        ...
        final int idx = node_group_count & 7;
        final int colour = (colours[idx] + node_group_count) | 0x808080;
    ...
    if (link_group) {
      final int idx = link_group_count & 7;
      colour = (colours[idx] + link_group_count) | 0x808080;
      link_group_count++;
