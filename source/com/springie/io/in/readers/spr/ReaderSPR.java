  ...
  public void startElement(String uri, String name, String qName,
      ...
      for (int i = 0; i < n; i++) {
        ...
        if (is_position) {
          ...
          if ("radius".equals(nam)) {
            ...
            this.type_link.tension = "true".equals(val);
            this.type_link.compression = !"true".equals(val);
          } else if ("compression".equals(nam)) {
            this.type_link.compression = "true".equals(val);
            //Log.log("NO COMPRESSION:" + this.type_link.compression);
          } else if ("tension".equals(nam)) {
            this.type_link.tension = "true".equals(val);
          ...
          if ("gravity_strength".equals(nam)) {
            ...
            this.out.append("CE:" + ("true".equals(val) ? "1" : "0") + " ");
                    } else if ("continuously_centre_x".equals(nam)) {
            this.out.append("CX:" + ("true".equals(val) ? "1" : "0") + " ");
                    } else if ("continuously_centre_y".equals(nam)) {
            this.out.append("CY:" + ("true".equals(val) ? "1" : "0") + " ");
                    } else if ("continuously_centre_z".equals(nam)) {
            this.out.append("CZ:" + ("true".equals(val) ? "1" : "0") + " ");
    ...
    if (is_type) {
      if (this.in_nodes_section) {
        ...
        if (!this.type_link.compression) {
          this.out.append("CP:0 ");
          //Log.log("NO COMPRESSION 2");
        }
        if (!this.type_link.tension) {
          this.out.append("TE:0 ");
        }
...
//  }
  ...
  private void outputNodeDescription(final String desc) {
    this.out.append("V:" + desc + " ");
    this.number++;
  }
