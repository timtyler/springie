...
public class Node extends BaseElement {
  ...
  public Vector3D velocity_delta = new Vector3D(0, 0, 0);
  ...
  public void travel() {
    ...
    if (!FrEnd.three_d) {
      this.pos.z = Coords.getInternalFromPixelCoords(DEFAULT_2D_DEPTH);
    }
  }
...
//    Vector3D velocity_delta = this.velocity_delta;
//    
//    this.velocity.addTuple3D(velocity_delta);
//
//  }

// public void resetVelocityDelta() {
//   //Vector3D velocity_delta = this.velocity_delta;
//   velocity_delta.x = 0;
//   velocity_delta.y = 0;
//   velocity_delta.z = 0;
