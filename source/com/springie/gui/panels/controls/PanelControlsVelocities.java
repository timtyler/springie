...
public class PanelControlsVelocities {
  ...
  private Panel makePanelVelocityReduce() {
    ...
    return panel_edit_make_motionless;
  }
  
  private Panel makePanelVelocityFreeze() {
    // MAKE_MOTIONLESS
    this.button_edit_freeze = new Button(
        GUIStrings.VELOCITY_FREEZE);
    ...
    final Panel panel_edit_make_motionless = new Panel();
    panel_edit_make_motionless.add(this.button_edit_freeze);
  ...
  private Panel makePanelVelocityReverse() {
    // MAKE_MOTIONLESS
    this.button_edit_reverse = new Button(
        GUIStrings.VELOCITY_REVERSE);
    ...
    final Panel panel_edit_make_motionless = new Panel();
    panel_edit_make_motionless.add(this.button_edit_reverse);
