...
public class PanelPreferencesRendererModern {
  ...
  void makePanel() {
    ...
    final Checkbox checkbox_show_bins = new Checkbox(GUIStrings.SHOW_BINS,
        RendererBinManager.show_bins);
  ...
  private Component getPanelLabelsWhen() {
    ...
    this.choose_label_when = new TTChoice(new ItemListener() {
      public void itemStateChanged(ItemEvent e) {
        ...
        final int val = PanelPreferencesRendererModern.this.choose_label_when
            .str_to_num(scs);
  ...
  private Panel panelNodePolyhedron() {
    ...
    this.choose_polyhedron = new TTChoice(new ItemListener() {
      public void itemStateChanged(ItemEvent e) {
        final String scs = (String) e.getItem();
        final int val = PanelPreferencesRendererModern.this.choose_polyhedron
            .str_to_num(scs);
        if (val == 1) {
  ...
  private Panel getPanelStrutDivisions() {
    ...
    final Scrollbar scroll_bar = new Scrollbar(Scrollbar.HORIZONTAL,
        ElementRendererLink.strut_divisions, 1, 1, 8);
    scroll_bar.addAdjustmentListener(new AdjustmentListener() {
      public void adjustmentValueChanged(AdjustmentEvent e) {
        final int temp = e.getValue();
  ...
  private Panel getPanelCableDivisions() {
    ...
    final Scrollbar scroll_bar = new Scrollbar(Scrollbar.HORIZONTAL,
        ElementRendererLink.cable_divisions, 1, 1, 8);
    scroll_bar.addAdjustmentListener(new AdjustmentListener() {
      public void adjustmentValueChanged(AdjustmentEvent e) {
        final int temp = e.getValue();
