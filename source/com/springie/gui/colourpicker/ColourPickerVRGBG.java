...
public class ColourPickerVRGBG extends ColourPickerBase {
  ...
  public void update(Graphics g) {
    ...
    for (int j = this.margin; j < this.range; j++) {
      ...
      final int green = (j * 255) / this.range;
    ...
    final int value = this.colour_picker.green;

    paintString(g, this, "Green: " + value);
  ...
  public void mouseClicked(MouseEvent e) {
    ...
    this.colour_picker.green = (this.x * 255) / this.range;
