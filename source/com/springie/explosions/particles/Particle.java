...
public class Particle {
  ...
  void draw() {
    switch (this.type) {
      case BLOB :
        RendererDelegator.graphics_handle.fillRect(this.x >>> shift, this.y >>> shift,
            size_LUT_x[this.count >> 3], size_LUT_y[this.count >> 3]);

        break;

      case POINT :
        RendererDelegator.graphics_handle.fillRect(this.x >>> shift, this.y >>> shift, 1, 1);
      ...
      case CROSS :
        ...
        RendererDelegator.graphics_handle.drawLine((this.x >>> shift) - size_x, this.y >>> shift,
            (this.x >>> shift) + size_x, this.y >>> shift);
        RendererDelegator.graphics_handle.drawLine(this.x >>> shift, (this.y >>> shift) - size_y,
