 ...
 * <UL>
 * <LI><a href="Shoals.html">Shoals </a>- the main class for the project; </LI>
 * <LI><a href="Module.html">Module </a>- the class that implements extensions;</LI>
 ...
 * <LI><a href="World.html">World </a>- the class that represents a collection
 * of <a href="Node.html">Node </a>s;</LI>
...
public final class Coords {
  ...
  static void drawLine2(Graphics g, int _x1, int _y1, int _z1, int _x2,
    ...
    final int _y1a = Coords
        .getYCoords(_y1 << Coords.shift, _z1 << Coords.shift);

    final int _x2a = Coords
        .getXCoords(_x2 << Coords.shift, _z2 << Coords.shift);
    final int _y2a = Coords
        .getYCoords(_y2 << Coords.shift, _z2 << Coords.shift);
  ...
  public static void drawLine(Graphics g, int _x1, int _y1, int _z1, int _x2,
    ...
    final int _x2a = Coords.getXCoords(_x2, _z2);
    final int _y2a = Coords.getYCoords(_y2, _z2);
